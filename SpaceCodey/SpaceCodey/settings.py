"""
Django settings for SpaceCodey project.
...
X_API_KEY = os.getenv('X_API_KEY', 'default-x-api-key')  
...
MIDDLEWARE = [
    ...
    'SpaceCodey.middleware.APIKeyMiddleware',
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR,BASE_DIR / "frontend" / "dist",],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'SpaceCodey.wsgi.application'
REST_FRAMEWORK = {
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / "frontend" / "dist" / "assets",  # React static files
...
EMAIL_HOST = 'smtp.gmail.com'  # Replace with your email host provider
EMAIL_PORT = 587  # Or the port number provided by your email service
EMAIL_USE_TLS = True  # Use TLS if your provider recommends it
EMAIL_USE_SSL = False
